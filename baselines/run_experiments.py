...
if __name__ == '__main__':
    ...
    parser.add_argument('--track', type=str, choices=['austria', 'columbia', 'treitlstrasse_v2', 'Ciircv2'], required=True)
    ...
    parser.add_argument('--training_time_limit', type=int, required=False, default=4000)
    parser.add_argument('--eval_time_limit', type=int, required=False, default=8000)
    parser.add_argument('--eval_interval', type=int, required=False, default=10000)
